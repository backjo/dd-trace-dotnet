    ...
    public class AspNetMvc4Tests : TestHelper, IClassFixture<IisFixture>
    {
        ...
        public static TheoryData<string, string, HttpStatusCode, bool, string, string, Dictionary<string, string>> Data =>
            new TheoryData<string, string, HttpStatusCode, bool, string, string, Dictionary<string, string>>
            {
                ...
                { "/Home/identifier", "GET /home/identifier", HttpStatusCode.InternalServerError, true, null, null, IdentifierTags() },
                ...
                { "/Home/OptionalIdentifier/123", "GET /home/optionalidentifier/{id}", HttpStatusCode.OK, false, null, null, OptionalIdentifierTags() },
                { "/Home/OptionalIdentifier/BadValue", "GET /home/optionalidentifier/{id}", HttpStatusCode.OK, false, null, null, OptionalIdentifierTags() },
        ...
        private static Dictionary<string, string> OptionalIdentifierTags() =>
            new Dictionary<string, string>
            {
                { Tags.AspNetRoute, DefaultRoute() },
                { Tags.AspNetController, "home" },
